...
<head>
  ...
  <body>
    <form method="post" action="<?php echo site_url('admin/updateRow')?>" id="adminAdd" class="definewidth m10">
    ...
    <table class="table table-bordered table-hover ">
         ...
         <tbody><tr>
            ...
            <td width="80%"><input type="text" value="<?php echo $arr['nickname'] ?>" name="nickname" data-rules="{required:true,minlength:3,maxlength:20}"></td>
        </tr>
        <tr>
            <td width="20%" class="tableleft">真实姓名</td>
            <td width="80%"><input type="text" value="<?php echo $arr['truename'] ?>" name="truename" data-rules="{required:true,minlength:3,maxlength:20}"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="80%">
              <?php foreach($aidAndInfo as $v)  : ?>
                <label><input name="auth[]" type="checkbox" value="<?php  echo $v['aid']; ?>" 
