...
<head>
  ...
  <body>
    <form method="post" action="<?php echo site_url('auth/updateRow')?>" id="form1" class="definewidth m10">
    ...
    <table class="table table-bordered table-hover ">
         ...
         <tbody><tr>
            ...
            <td width="20%" class="tableleft">控制器/方法</td>
            <td width="80%"><input type="text" value="<?php echo $arr['name'] ?>" name="name" data-rules="{required:true,minlength:3,maxlength:20}"></td>
        </tr>
        <tr>
            <td width="20%" class="tableleft">权限信息</td>
            <td width="80%"><input type="text" value="<?php echo $arr['info'] ?>" name="info" data-rules="{required:true,minlength:1,maxlength:20}"></td>
        </tr>
        <tr>
