...
<body>
    ...
    <form method="post" enctype="multipart/form-data"  action="<?php echo site_url('active/insertRow') ?>
      ...
      <table class="table table-bordered table-hover ">
        ...
        <tbody>
          <tr>
            ...
            <td width="80%">
              <input type="text" name="name" style="width:200px;height:20px"  data-rules="{required:true,minlength:1,maxlength:20}"></td>
          </tr>
          <tr>
            <td width="20%" class="tableleft">所属商户</td>
            <td width="80%">
              <select data-rules="{required:true}" name="sid" style="width:200px;height:20px" >
          ...
          <tr>
            ...
            <td width="80%">
              <input type="text" name="old_price" style="width:200px;height:20px"  data-rules="{required:true,number:true}"></td>
          </tr>
          <tr>
            <td width="20%" class="tableleft">现价</td>
            <td width="80%">
              <input type="text" name="now_price" style="width:200px;height:20px"  data-rules="{required:true,number:true}"></td>
          </tr>
          <tr>
            <td width="20%" class="tableleft">购买链接</td>
            <td width="80%">
              <input type="text" name="alink" style="width:200px;height:20px" data-rules="{required:true}"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="80%">
                <input type="text" style="width:200px;height:20px"  class="calendar calendar-time" name="start_time" data-rules="{required:true}"/>
            </td>
          </tr>
          <tr>
            <td width="20%" class="tableleft">结束时间</td>
            <td width="80%">
              <input type="text" style="width:200px;height:20px"  class="calendar calendar-time" name="end_time" data-rules="{required:true}"/>
            </td>
          </tr>
          <tr>
            <td width="20%" class="tableleft">套餐详情</td>
            <td width="80%">
              <textarea id="editor_id1" name="package"  style="width:700px;height:300px;"></textarea>
            </td>
          </tr>
          <tr>
            <td width="20%" class="tableleft">购买须知</td>
            <td width="80%">
              <textarea id="editor_id2" name="desc" style="width:700px;height:300px;"></textarea>
            </td>
          </tr>
          <tr>
            <td width="20%" class="tableleft">排序依据</td>
            <td width="80%">
              <input type="text" name="flag" style="width:200px;height:20px"  value="0" data-rules="{required:true}"></td>
          </tr>
          <tr>
