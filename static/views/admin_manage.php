...
<head>
  ...
  <body>
    ...
    <form method="GET" action="<?php echo site_url('admin/manage');  ?>" id="" class="form-inline definewidth m20">
   
        
  
        &nbsp;&nbsp;昵称:<input type="text" name="nickname" class="input-default">
        &nbsp;&nbsp;真实姓名:<input type="text" name="truename" class="input-default">
                  ...
                  <?php foreach($list as $v) :  ?>
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="<?php echo site_url('admin/edit').'?uid='.$v['uid']; ?>">编辑</a>
                          <a href="javascript:void(0)" data-id="<?php echo $v['uid'] ?>" onClick="del(this)">删除</a>
                      </td>
                    </tr>
  ...
  <script>
      ...
      function del(obj)
      {
        if(confirm("确认删除么?"))
        {
          $.ajax({
            type:'get',
            url:'<?php echo site_url('Admin/deleteRow'); ?>',
            datatype:'json',
            data:{uid:obj.dataset.id},
