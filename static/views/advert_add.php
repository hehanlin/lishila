...
<head>
  ...
  <body>
    ...
    <form method="post" enctype="multipart/form-data" action="<?php echo site_url('advert/insertRow') ?>" id="form1" class="definewidth m10">
    ...
    <table class="table table-bordered table-hover ">
         ...
         <tbody>
          <tr>
              ...
              <td width="80%"><input type="text" name="name" data-rules="{required:true,minlength:1,maxlength:40}"></td>
          </tr>  
          <tr>
              <td width="20%" class="tableleft">广告图片</td>
              <td width="80%"><input type="file" name="img"></td>
          </tr>
          <tr>
              <td width="20%" class="tableleft">广告链接</td>
              <td width="80%"><input type="text" name="a" style="width:300px" data-rules="{required:true}"></td>
          </tr>
        <tr>
            <td width="20%" class="tableleft">是否可用</td>
            <td width="80%"><input type="radio" value="1" checked="checked" name="isintro"/>可用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" value="0" name="isintro"/>禁用</td>
        </tr>
