...
<head>
  ...
  <body>
    ...
    <form method="GET" action="<?php echo site_url('advert/manage') ?>" id="form1" class="form-inline definewidth m20">
            ...
            <?php foreach($list as $v) :  ?>
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="<?php echo site_url('advert/edit').'?aid='.$v['aid']; ?>">编辑</a>
  ...
  <script>
      ...
      function del(obj)
      {
        if(confirm("确认删除么?"))
        {
          $.ajax({
            type:'get',
            url:'<?php echo site_url('Advert/deleteRow'); ?>',
            datatype:'json',
            ...
            success:function(data)
            {
              if(data == 1 || data == "1")
              {
                  window.location.href = "<?php echo site_url('advert/manage'); ?>"
              }
              else
              {
                alert('删除失败!');
