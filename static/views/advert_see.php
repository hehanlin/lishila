...
<head>
  ...
  <body>
    ...
    <form method="GET" action="<?php echo site_url('advert/see') ?>" id="form1" class="form-inline definewidth m20">
   
        
  
        &nbsp;&nbsp;广告名称:<input type="text" name="name" class="input-default">
         &nbsp;&nbsp;<input type="submit" value="查询" id="Button1" class="button button-primary">&nbsp;&nbsp;  
        <input type="button" value="导出数据" id="Button2" class="button button-success" onclick="AllAreaExcel(tab)">
        </form>
          ...
          <tbody>
            <?php foreach($list as $v) :  ?>
                    ...
                    <tr>
                      ...
                      <td><?php echo $v['isintro']  == 1  ? "可用" : "禁用"  ; ?></td>
                    </tr>
  ...
  <script type="text/javascript" src="<?php echo base_url('static/js/table.js') ?>"></script>
  </body>
</html>