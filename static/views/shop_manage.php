...
<head>
  ...
  <body>
      ...
      <form method="GET" action="<?php echo site_url('shop/manage');  ?>" id="" class="form-inline definewidth m20">
     
          
    
          &nbsp;&nbsp;商户登录名:<input type="text" name="nickname" class="input-default">
          &nbsp;&nbsp;商户名称:<input type="text" name="truename" class="input-default">
                    ...
                    <?php foreach($list as $v) :  ?>
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo site_url('shop/edit').'?sid='.$v['sid']; ?>">编辑</a>
                            <a href="javascript:void(0)" data-id="<?php echo $v['sid'] ?>" onClick="del(this)">删除</a>
                        </td>
                      </tr>
    ...
    <script>
        ...
        function del(obj)
        {
          if(confirm("确认删除么?"))
          {
            $.ajax({
              type:'get',
              url:'<?php echo site_url('Shop/deleteRow'); ?>',
              datatype:'json',
              ...
              success:function(data)
              {
                if(data == 1 || data == "1")
                {
                    window.location.href = "<?php echo site_url('shop/manage'); ?>"
                }
                else
                {
                  alert('删除失败!');
