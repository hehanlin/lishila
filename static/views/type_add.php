...
<head>
  ...
  <body>
    ...
    <form method="post" enctype="multipart/form-data" action="<?php echo site_url('type/insertRow') ?>" id="form1" class="definewidth m10">
    
    <table class="table table-bordered table-hover ">
        
         <tbody>
          <tr>
              <td width="20%" class="tableleft">类别名称</td>
              <td width="80%"><input type="text" name="name" data-rules="{required:true,minlength:1,maxlength:20}"></td>
          </tr>  
          <tr>
              <td width="20%" class="tableleft">类别图片</td>
