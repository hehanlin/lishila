...
<head>
  ...
  <body>
    <form enctype="multipart/form-data" method="post" action="<?php echo site_url('type/updateRow')?>" id="form1" class="definewidth m10">
    ...
    <table class="table table-bordered table-hover ">
         ...
         <tbody><tr>
            ...
            <td width="80%"><input type="text" value="<?php echo $arr['name'] ?>" name="name" data-rules="{required:true,minlength:1,maxlength:20}"></td>
        </tr>
        <tr>
